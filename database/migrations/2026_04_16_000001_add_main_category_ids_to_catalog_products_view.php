...
/**
 * Adds `main_category_ids` computed column to catalog.products_view.
 *
 * Uses a recursive CTE to walk the category parent chain and identify which
 * "main categories" (custom_fields @> '{"is_main_category": true}') each product
 * belongs to, either directly or via descendant categories.
 *
 * Products with no main category ancestry return `main_category_ids: []`.
 *
