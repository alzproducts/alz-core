...
{
    // ─────────────────────────────────────────────────────────────────────────
    // Test Helpers (public for Pest closure access)
    // ─────────────────────────────────────────────────────────────────────────

    public static function createRequest(): Request
    {
        return Request::create('/helpscout/conversations/assigned');
    }
...
\describe('ConversationResource', static function (): void {
    \it('formats all dates as ISO 8601 strings', static function (): void {
        // Arrange
        $conversation = ConversationApiContractTest::createConversation();
        $resource = new ConversationResource($conversation);

        // Act
        $result = $resource->toArray(ConversationApiContractTest::createRequest());
    ...
    \it('maps customer to primaryCustomer key', static function (): void {
        // Arrange
    ...
    \it('reconstructs customerWaitingSince as object with time and friendly', static function (): void {
        // Arrange
        $conversation = ConversationApiContractTest::createConversation([
            'customerWaitingSince' => new DateTimeImmutable('2024-01-15T09:00:00', new DateTimeZone('UTC')),
            'customerWaitingFriendly' => '2 hours ago',
    ...
    \it('omits customerWaitingSince.friendly when null', static function (): void {
        // Arrange
        $conversation = ConversationApiContractTest::createConversation([
            'customerWaitingSince' => new DateTimeImmutable('2024-01-15T09:00:00', new DateTimeZone('UTC')),
    ...
    \it('omits customerWaitingSince entirely when null', static function (): void {
        // Arrange
        $conversation = ConversationApiContractTest::createConversation([
    ...
    \it('omits null optional fields from output', static function (): void {
        // Arrange
        $conversation = ConversationApiContractTest::createConversation([
            'assignee' => null,
            'snooze' => null,
        ...
        // Assert - these keys should NOT exist (not be null values)
    ...
    \it('transforms tags using TagResource', static function (): void {
        // Arrange
        $tags = [
    ...
    \it('includes empty tags array when no tags', static function (): void {
        // Arrange
        ...
        // Assert - tags should be present (not omitted) and empty
        // Note: TagResource::collection() returns an AnonymousResourceCollection
        // The underlying resource is the empty array
        \expect($result)->toHaveKey('tags');
        \expect($result['tags']->resource)->toBeInstanceOf(Collection::class);
        \expect($result['tags']->resource)->toBeEmpty();
    });

    \it('full conversation matches expected API contract', static function (): void {
        // Arrange - Create a fully populated conversation
        $conversation = ConversationApiContractTest::createConversation([
            'id' => 12345,
            'number' => 6789,
        ...
        // Assert - Verify structure matches API contract
...
\describe('TagResource', static function (): void {
    \it('maps name property to tag key', static function (): void {
        // Arrange
    ...
    \it('includes id and color fields', static function (): void {
        // Arrange
    ...
    \it('includes color as null when not set', static function (): void {
        // Arrange
        ...
        // Assert - Tags always include all fields (id, tag, color)
...
\describe('SnoozeResource', static function (): void {
    \it('maps snoozedByUserId to snoozedBy key', static function (): void {
        // Arrange
    ...
    \it('formats snoozedUntil as ISO 8601 string', static function (): void {
        // Arrange
        $snooze = ConversationApiContractTest::createSnooze([
            'snoozedUntil' => new DateTimeImmutable('2024-01-16T09:00:00', new DateTimeZone('UTC')),
        ]);
    ...
    \it('includes unsnoozeOnCustomerReply field', static function (): void {
        // Arrange
    ...
    \it('omits null fields from output', static function (): void {
        // Arrange
        $snooze = ConversationApiContractTest::createSnooze([
...
\describe('AssigneeResource', static function (): void {
    \it('includes email when present', static function (): void {
        // Arrange
    ...
    \it('includes firstName and lastName', static function (): void {
        // Arrange
        $assignee = ConversationApiContractTest::createAssignee([
            'firstName' => 'John',
            'lastName' => 'Agent',
...
\describe('CustomerResource', static function (): void {
    \it('maps firstName to first and lastName to last', static function (): void {
        // Arrange
        $customer = ConversationApiContractTest::createCustomer([
            'firstName' => 'Jane',
            'lastName' => 'Doe',
    ...
    \it('includes email field', static function (): void {
        // Arrange
    ...
    \it('handles partial null fields correctly', static function (): void {
        // Arrange - Only firstName is set
        $customer = ConversationApiContractTest::createCustomer([
            'firstName' => 'Jane',
            'lastName' => null,
            'email' => 'jane@example.com',
