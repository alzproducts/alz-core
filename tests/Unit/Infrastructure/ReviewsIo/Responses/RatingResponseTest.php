...
/**
 * RatingResponse DTO Unit Tests
 *
 * Tests the Infrastructure layer RatingResponse DTO covering:
 ...
 */
#[CoversClass(RatingResponse::class)]
final class RatingResponseTest extends TestCase
{
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    public function it_maps_snake_case_api_response_to_camel_case_properties(): void
    {
        ...
        $rating = RatingResponse::from($apiResponse);
