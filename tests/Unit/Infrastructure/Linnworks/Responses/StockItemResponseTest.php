...
/**
 * StockItemResponse DTO Unit Tests.
 *
 ...
 */
#[CoversClass(StockItemResponse::class)]
final class StockItemResponseTest extends TestCase
{
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    {
        $dto = StockItemResponse::from(self::validApiResponse());
    ...
    public function it_handles_null_weight(): void
    {
        ...
        $dto = StockItemResponse::from($data);
