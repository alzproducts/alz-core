...
/**
 * SkuStockIdMappingResponse DTO Unit Tests.
 *
 ...
 */
#[CoversClass(SkuStockIdMappingResponse::class)]
final class SkuStockIdMappingResponseTest extends TestCase
{
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    {
        $dto = SkuStockIdMappingResponse::from([
