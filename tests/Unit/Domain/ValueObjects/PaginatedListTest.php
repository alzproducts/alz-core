...
#[CoversClass(PaginatedList::class)]
final class PaginatedListTest extends TestCase
{
    ...
    */
    ...
    {
        $dto = PaginatedList::fromPage(items: [], total: 100, perPage: 10, currentPage: 1);
    ...
    {
        $dto = PaginatedList::fromPage(items: [], total: 101, perPage: 10, currentPage: 1);
    ...
    {
        $dto = PaginatedList::fromPage(items: [], total: 0, perPage: 10, currentPage: 1);
    ...
    {
        $dto = PaginatedList::fromPage(items: ['item'], total: 1, perPage: 10, currentPage: 1);
    ...
    public function from_page_uses_max_guard_to_prevent_division_by_zero_when_per_page_is_zero(): void
    {
        ...
        $dto = PaginatedList::fromPage(items: [], total: 5, perPage: 0, currentPage: 1);
    ...
    */
    ...
    public function from_page_preserves_all_properties(): void
    {
        ...
        $dto = PaginatedList::fromPage(items: $items, total: 30, perPage: 10, currentPage: 2);
