...
final class SyncShippingOffersFiltersUseCaseTest extends TestCase
{
    ...
    */
    ...
    {
        $changes = [
            new ProductFilterChangeDTO(IntId::from(1001), 20, [ShippingOffersFilterValue::FreeStandardDelivery]),
            new ProductFilterChangeDTO(IntId::from(1002), 20, [ShippingOffersFilterValue::FreeExpressDelivery]),
        ];
    ...
    */
    ...
    {
        $changes = [
            new ProductFilterChangeDTO(IntId::from(1001), 20, []),
        ];
    ...
    */
    ...
    public function execute_handles_mix_of_add_and_remove_filter_values(): void
    {
        $changes = [
            new ProductFilterChangeDTO(IntId::from(1001), 20, [ShippingOffersFilterValue::FreeStandardDelivery]),
            new ProductFilterChangeDTO(IntId::from(1002), 20, []),
            new ProductFilterChangeDTO(IntId::from(1003), 20, [ShippingOffersFilterValue::FreeExpressDelivery]),
        ];
