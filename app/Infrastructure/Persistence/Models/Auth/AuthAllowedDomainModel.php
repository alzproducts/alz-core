...
/**
 * Eloquent model for the auth_allowed_domains table.
 *
 ...
 * @property string|null $added_by UUID of profile who added this domain
 * @property CarbonImmutable|null $created_at
 */
final class AuthAllowedDomainModel extends Model
{
    use HasUuids;
