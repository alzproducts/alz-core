...
use App\Application\Conversion\CallTracking\UseCases\ProcessBingCallLeadConversionUseCase;
...
final class ProcessBingCallLeadConversionJob implements ShouldBeUnique, ShouldQueue
{
     ...
     */
    public function handle(ProcessBingCallLeadConversionUseCase $useCase): void
    {
        try {
