...
use App\Application\Catalog\UseCases\SyncProductSortOrdersUseCase;
...
final class SyncProductSortOrdersJob extends AbstractJob implements ShouldBeUnique
{
    ...
    {
        return 'sync-product-sort-orders';
    }
     ...
     */
    public function handle(SyncProductSortOrdersUseCase $useCase): void
    {
        $useCase->execute();
    }
}
