...
/**
 * Receives all ShopWired category-related webhook events and routes them
 ...
 */
final readonly class ShopwiredWebhookCategoryController
{
    public function __construct(private HandleCategoryWebhookService $service) {}
