...
/**
 * Update selling prices for a single product's SKUs via ShopWired batch API.
 *
 * Handles price, salePrice (NOT RRP/comparePrice — that's UpdateProductRetailPricesUseCase).
 ...
 */
final readonly class UpdateProductSellingPricesUseCase
{
