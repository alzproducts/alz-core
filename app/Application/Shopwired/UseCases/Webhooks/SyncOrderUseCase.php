...
final readonly class SyncOrderUseCase extends AbstractSyncEntityWebhookUseCase
{
     ...
     */
    public function execute(WebhookContextDTO $context, Order $order): void
    {
        $this->process($context, $order->id, $order);
    }
    ...
    {
        $this->dispatcher->dispatchEntitySync(ShopwiredEntityType::Order, $entityId);
    }
