...
final readonly class SyncBrandUseCase extends AbstractSyncEntityWebhookUseCase
{
     ...
     */
    public function execute(WebhookContextDTO $context, Brand $brand, array $presentEmbeds = []): void
    {
        $this->process($context, $brand->id, $brand, $presentEmbeds);
    }
    ...
    {
        $this->dispatcher->dispatchEntitySync(ShopwiredEntityType::Brand, $entityId);
    }
