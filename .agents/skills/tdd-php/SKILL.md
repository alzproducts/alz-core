...
**Good tests** are behavior-focused and sociable: they exercise real code paths through public APIs, mocking only at layer boundaries. They describe _what_ the system does, not _how_ it does it. A good test reads like a specification - "user can checkout with valid cart" tells you exactly what capability exists. These tests survive refactors because they don't care about internal structure.
